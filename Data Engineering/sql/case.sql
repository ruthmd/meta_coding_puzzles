...
SELECT 
    COUNT(CASE WHEN s.transaction_date = p.start_date OR s.transaction_date = p.end_date THEN 1 END) * 100.0 / COUNT(*) AS pct_of_transactions_on_first_or_last_day_of_valid_promotion
FROM 
    sales s
JOIN 
