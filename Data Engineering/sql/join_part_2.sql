...
SELECT 
  (COUNT(DISTINCT pc.product_category) - COUNT(DISTINCT CASE WHEN s.product_id IS NOT NULL THEN pc.product_category END)) 
  / CAST(COUNT(DISTINCT pc.product_category) AS DECIMAL) * 100 AS pct_product_categories_never_sold
